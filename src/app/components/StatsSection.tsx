        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {statsList.map((stat, index) => (
            ...
            >
              ...
              <h3
                className={`${inter.className} font-extrabold text-3xl md:text-4xl lg:text-5xl text-[#F9F9F9] flex justify-center gap-1`}
              >
                <CountUp end={parseInt(stat.value.replace(/\D/g, ""), 10)} />

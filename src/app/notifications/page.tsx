                ...
                <div className="w-[40%] pe-3">
                  <div className="flex flex-col h-full items-center justify-between bg_notification_project p-5 ">
                    ...
                    <div>
                      ...
                      ></div>
                      <CommonBtn btnName="View All" btnStyling="bg-white text-[#213737] border-1 border-transparent !px-5 !py-2 leading-[100%]" arrowIcon="hidden" />
                    </div>
                  </div>
                </div>
                <div className="w-[30%] px-3">
                  <div className="flex h-full flex-col items-center justify-between shadow-[0px_3.5px_5.5px_0px_#00000005] bg-[#FFFFFF] rounded-[15px]  p-5">
                    ...
                    <div>
                      ...
                      ></div>
                      <CommonBtn btnName="View All" btnStyling="bg-white text-[#213737] border-1 border-[#2C4C4B] !px-5 !py-2 leading-[100%]" arrowIcon="hidden" />
                    </div>
                  </div>
                </div>
            ...
            <div className="w-full xl:w-[37.68%]  xl:ps-3 mt-6 xl:mt-0">
              <div className="p-6 bg-white rounded-[15px] shadow-[0_3.5px_5.5px_0_#00000005]">
                <div className="flex justify-between items-center mb-6">
                  ...
                  <CommonBtn btnName="View All" btnStyling="font-bold text-[14px] text-[#2C4C4B] border-1 border-[#2C4C4B] rounded-4 !py-2 !px-5" arrowIcon="hidden" />
                </div>

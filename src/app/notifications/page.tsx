        ...
        <div className="w-full xl:w-[62.32%] xl:pe-3">
            ...
            <div className="w-[40%] pe-3">
              <div className="flex flex-col h-full items-center justify-between bg_notification_project p-5 ">
                ...
                <div>
                  ...
                  ></div>
                  <CommonBtn btnName="View All" btnStyling="bg-white text-[#213737] border-1 border-transparent !px-5 !py-2 leading-[100%] text-[12px] xl:text[14px]" arrowIcon="hidden" />
                </div>
              </div>
            </div>
            <div className="w-[30%] px-3">
              <div className="flex h-full flex-col items-center justify-between shadow-[0px_3.5px_5.5px_0px_#00000005] bg-[#FFFFFF] rounded-[15px]  p-5">
                ...
                <div>
                  ...
                  ></div>
                  <CommonBtn btnName="View All" btnStyling="bg-white text-[#213737] border-1 border-[#2C4C4B] !px-5 !py-2 leading-[100%] text-[12px] xl:text[14px]" arrowIcon="hidden" />
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 bg-white rounded-[15px] p-6 shadow-[0px_3.5px_5.5px_0px_#00000005]">
            <div className="flex justify-between">
              ...
              <div>
                <CommonBtn btnName="Mark as read" btnStyling="text-white font-bold text-[14px] bg-[#2C4C4B] !px-5 !py-2 " arrowIcon="hidden" />
              </div>
            </div>
            <div className="mt-7">
                ...
                <tbody>
                  {notification_urgent_task.slice(0, 5).map((task, id) => (
                    <tr key={id} className="border-b border-gray-200 ">
                      <td className="py-4 px-5 font-bold text-[14px] text-[#213737]">{task.name}</td>
                      <td className="py-4 px-5 font-bold text-[14px] text-[#213737] ">
                        ...
                        <div className="w-full h-1 bg-gray-300 rounded-lg">
                          <div style={{ width: `${task.progress * 10}%` }} className="h-full bg-[#2C4C4B] rounded-lg"></div>
                        </div>
                      </td>
                      ...
                      <td className="py-4 px-5 text-[14px] text-[#9A9999] font-bold">
                        <Link href={""}>View</Link>
                        <Link className="ms-6" href={""}>Edit</Link>
                      </td>
                    </tr>
                  ))}
                </tbody>
          ...
          <div className="mt-6 bg-white rounded-[15px] p-6 shadow-[0px_3.5px_5.5px_0px_#00000005]">
            <div className="flex justify-between">
              ...
              <div>
                <CommonBtn btnName="Mark as read" btnStyling="text-white font-bold text-[14px] bg-[#2C4C4B] !px-5 !py-3 " arrowIcon="hidden" />
              </div>
            </div>
            <div className="mt-7">
              <table className="w-full">
        ...
        <div className="w-full xl:w-[37.68%]  xl:ps-3 mt-6 xl:mt-0">
          <div className="p-6 bg-white rounded-[15px] shadow-[0_3.5px_5.5px_0_#00000005]">
            <div className="flex justify-between items-center mb-6">
              ...
              <CommonBtn btnName="View All" btnStyling="font-bold text-[12px] xl:text[14px] text-[#2C4C4B] border-1 border-[#2C4C4B] rounded-4 !py-2 !px-5 " arrowIcon="hidden" />
            </div>
            {notification_new_message.map((task, id) => (
              <div key={id} className="px-3 2xl:px-5 py-3 flex items-center  border-b-[1px] border-[#EAEBEB]">
                <Image src={task.image} style={{ width: "40px", height: "40px" }} width={40} height={40} className="object-cover rounded-full" alt="img" />
                <div className="ms-4">
                  <div className="flex  justify-between">
                    <h3 className="text-[14px] font-bold text-[#213737]">{task.name}</h3>
                    <h3 className="text-[12px] font-bold text-[#9A9999] ">{task.time}</h3>
                  </div>
                  <p className="one-line-ellipsis text-[#9A9999] font-[400] text-[14px]">{task.message}</p>
                </div>
              </div>
            ))}
          </div>

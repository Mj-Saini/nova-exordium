      ...
      <div className="flex flex-wrap h-full">
        ...
        <div className=" w-full md:w-[calc(100%-200px)] lg:w-[calc(100%-296px)]  px-2.5 lg:px-5">
          ...
          <div className="flex flex-wrap lg:mt-2 -mx-2.5 xl:-mx-3">
            {[1, 1, 1, 1].map((items) => (
              <div key={items.id} className="w-full sm:w-1/2 lg:w-3/12 px-2.5 xl:px-3 mt-5">
                <div className="flex justify-between px-3 2xl:px-6 py-4 rounded-2xl bg-white custom_shadow">
                  <div>
                    <p className="font-bold text-xs text-[#9A9999] pb-1">In progress</p>
                    <h3 className="font-semibold text-xl md:text-2xl lg:text-[28px] text-[#213737]">
                      54
                      <span className="text-sm text-[#477D7C] ms-1">Tasks in progress</span>
                    </h3>
                  </div>
                  <div>
                    <InProgressIcon />
              ...
              <div className="flex  justify-between px-3 2xl:px-6 py-4 rounded-2xl bg-white custom_shadow">
                <div className="w-full xl:w-7/12">
                  <div className="h-full flex flex-col justify-between">
                    ...
                    <Link href="/dashboard" className={`font-bold text-[10px] text-[#213737]`}>
